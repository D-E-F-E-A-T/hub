package org.toy.ir.printer;

import static org.toy.ir.printer.Util.isNonEmpty;
...
public abstract class ASMPrinter<E> extends Printer<E> {
    ...
    public static final String PROP_EXPAND_ACCESS_FLAGS = "hub.ir.printer.expandAccessFlags";
    public static final String PROP_ACCESS_FLAG_VERBOSITY = "hub.ir.printer.accessFlagVerbosity";
    public static final String PROP_ACCESS_FLAG_SAFE = "hub.ir.printer.safeAccessFlags";
